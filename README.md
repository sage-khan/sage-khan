...
**MSCA Personal Docente e Investigador**
1 Sept 2025 – Present

* Research on topic Secure IT framework for autonomous wind farm operation and maintenance based on blockchain, smart contracts and AI under Dr. Manuel Chiachio Ruano and Dr. Juan Chiachio Ruano, along with Dr. Juan Fernandez (QUANTIA ENGINEERING & CONSULTANCY, S.L.) for development of a secure, trustworthy, explainable, and interactive structural health monitoring (SHM) platform for wind farms combining AI algorithms, decentralized knowledge graphs, and blockchain.
...
* Development of MVP of Project Veritas, the blockchain-powered ontology aware agentic Polyglot Persistence Database.

[https://ipmlab.ugr.es/](https://ipmlab.ugr.es/)
[https://cordis.europa.eu/project/id/101168725](https://cordis.europa.eu/project/id/101168725)
[https://github.com/sage-khan/project-veritas](https://github.com/sage-khan/project-veritas)
[https://www.youtube.com/watch?v=SkJ33xHNQMQ](https://www.youtube.com/watch?v=SkJ33xHNQMQ)
...
* Organized and facilitated community workshops and webinars to educate professionals on the DataOps landscape, frameworks, and industry impact.
...
**AI-ASR Engineer (Volunteer Member)**
Part-Time
Oct 2021 – Dec 2022
...
## Freelance Audio Engineer and Music Composer | Upwork
...
## Open Source Network Deployment | Virtuous BPO
...
## Open Source Deployment for Efficient Office Administration | Virtuous BPO
...
## Open Source ERP and HRMIS Deployment | Virtuous BPO
...
## Open Source Offline LLM Deployment | Virtuous BPO
...
[https://github.com/sage-khan/llm-pdf-csv-conversion](https://github.com/sage-khan/llm-pdf-csv-conversion)

---

## Large Language Model Training Optimization | 41 Labs LLC, USA
...
## Process Automation Using RPA Framework | Virtuous BPO
...
## Deployment of Open Source SOC Using Wazuh | Virtuous BPO

Aug 2024 – In Progress
...
* Architecting the 5-Bot AI Implementation Project, specifically developing the Knowledge Bot using a GraphRAG approach (integrating Knowledge Graphs with Vector Databases) to enable high-fidelity retrieval of complex organizational data.
...
* Automated organizational employee attendance tracking by deploying and integrating Kimai and TimeTrex, streamlining HR operations and resource reporting via custom API integrations.
...
National University of Science & Technology - Pak Navy Engineering College
Karachi, Pakistan
Sep. 2020 – Oct. 2022
...
## IntelliWind MSCA-DN - Training School 1 | Technical University of Denmark (DTU)
...
## Incident Response Course | PDC NUST-PNEC
...
## Linux for System Administration | PDC NUST-PNEC
...
## Artificial Intelligence Workshop | PDC NUST-PNEC
...
## Computer Vision Workshop | PDC NUST-PNEC
...
## Basic Management Course | PNS RAHNUMA
...
## Logistics, Management, and Naval Law | PNS KARSAZ
...
## CBRNDC & Fire Fighting Course | PNS KARSAZ
...
## Junior Officer Staff Duties Course | PNS RAHNUMA
...
## Naval Operations Course | PNS BAHADUR
...
## Helicopter Controller Course | PNS MEHRAN
...
## Bridge Watch Keeping Certificate | PNS TARIQ (Type 21)
...
## Maritime Law Enforcement and Policing | HQ PMSA
...
## Russian Language Course (A1) – 72 Hours

28 October 2024
Ural State Pedagogical University - Centre for Open Education
...
## Silva Ultra Mind Instructor | Avlis Pro
...
## Certified Hypnotherapist | First Institute of Dynamic Learning by Kamran Sultan
...
## Fire & Glass Walk Course | First Institute of Dynamic Learning by Kamran Sultan
...
## Offline LATEX Editor & Customized Book Template (PN) | LATEX
...
## Code-Switched Urdu ASR for Noisy Telephonic Environment
...
## Head of Postgraduate Program | NUST-PNEC

2021 – 2022

* Led the administration and academic coordination of the postgraduate Cyber Security program.
* Oversaw curriculum development, academic scheduling, and quality assurance processes.
* Coordinated between faculty, management, and students to ensure academic and research alignment.
* Contributed to strategic planning for advanced cybersecurity lab infrastructure and research initiatives.

---

## Professional Development Center (PDC) Instructor

2021 – Present

* Delivered specialized short courses in AI, Cybersecurity, Incident Response, and Linux System Administration.
* Designed applied training modules integrating hands-on labs with theoretical foundations.
* Mentored working professionals transitioning into AI and security domains.

---

## Community Knowledge Contributor

* Published technical articles and policy commentary on Medium addressing AI governance, open-source strategy, renewable energy, and digital infrastructure reform.
* Advocated for open standards, technological sovereignty, and ethical AI adoption through research-backed writing and public discussions.

---

# Awards

## Gold Medal – Master of Science in Cyber Security

National University of Sciences & Technology (NUST-PNEC)
2022

* Graduated with CGPA 4.0 / 4.0.
* Awarded Gold Medal for highest academic performance in the program.

---

## Marie Skłodowska-Curie PhD Scholarship
...
## Multiple Academic Distinctions

* Consistent A and A* grades in GCE O and A Levels.
* Recognized for academic excellence in mathematics, sciences, and computing-related subjects.

---

# Hobbies

* Mixed Martial Arts (MMA) training and fitness conditioning.
* Reading philosophy, technology policy, and scientific literature.
* Writing fiction and non-fiction across technology and philosophical themes.
* Music production, audio engineering, and studio recording.
* Public speaking and rhetorical discourse.
* Researching renewable energy systems and emerging AI architectures.
